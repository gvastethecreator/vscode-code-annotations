...
- Project number: `30`
- Project title: `Annotations`
- Project URL: https://github.com/users/gvastethecreator/projects/30
- Local root: `.scratch/vscode-code-annotations/`
...
- Spec: `.scratch/vscode-code-annotations/spec.md` (`PRD.md` remains compatible).
- Ticket mirrors: `.scratch/vscode-code-annotations/issues/<NN>-<slug>.md`. Never under `docs/`.
- Rejected requests: `.scratch/vscode-code-annotations/out-of-scope/<concept>.md`.
...
GitHub project: https://github.com/users/gvastethecreator/projects/30
...
5. Add the Issue to Project `30` under `gvastethecreator`.
...
```powershell
gh issue view <number> -R gvastethecreator/vscode-code-annotations --json number,title,state,body,labels,assignees,comments,updatedAt,url
gh project view 30 --owner gvastethecreator --format json
gh project field-list 30 --owner gvastethecreator --format json
gh project item-list 30 --owner gvastethecreator --limit 200 --format json --field Status
gh project item-add 30 --owner gvastethecreator --url <issue-url>
gh project item-edit 30 --owner gvastethecreator --url <issue-url> --field Status --value Todo
gh issue create -R gvastethecreator/vscode-code-annotations --title <title> --body-file <path> --parent <parent-number> --blocked-by <number,number>
gh issue edit <issue-number> -R gvastethecreator/vscode-code-annotations --parent <parent-number> --add-blocked-by <number>
```
